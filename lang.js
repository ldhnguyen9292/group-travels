...
const translations = {
  en: {
    ...
    quote1: "“Finally, an app that makes group travel planning easy! No more messy group chats.”",
    ...
    savePDF: "📄 Export PDF",
    qrModalMessage: "Would you like to add the payer's QR code to the PDF file?",
    showQRModal: "🖼️ Yes",
    hideQRModal: "❌ No",
  ...
  vi: {
    ...
    quote1: "“Cuối cùng cũng có ứng dụng giúp lập kế hoạch du lịch nhóm dễ dàng! Không còn nhóm chat lộn xộn nữa.”",
    author1: "– Tửu, Hồ Chí Minh",
    quote2: "“Tính năng chia chi phí đã giúp nhóm chúng tôi tiết kiệm rất nhiều công sức.”",
    ...
    savePDF: "📄 Xuất PDF",
    qrModalMessage: "Bạn có muốn thêm mã QR thanh toán của người đại diện vào file PDF không?",
    showQRModal: "🖼️ Có",
    hideQRModal: "❌ Không",
