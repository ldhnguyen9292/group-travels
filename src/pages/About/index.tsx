...
const About: React.FC = () => {
  ...
  return (
    <main className="min-h-[70vh] bg-background py-12 px-4">
      <section className="max-w-3xl mx-auto bg-card rounded-2xl shadow-lg p-8 border bg-surface border-surface">
        <h2 className="text-3xl font-semibold mb-4 text-center">{t.title}</h2>
        <p className="mb-6 text-center leading-relaxed">{t.desc}</p>
        ...
        <div className="text-center text-secondary text-sm border-t border-surface pt-4">{t.version}</div>
      </section>
    </main>
  );
};
